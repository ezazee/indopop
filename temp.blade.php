...
<head>
    ...
    <meta name="description" content="Copyright 2024 © Botble Technologies. Version 7.4.7">
    ...
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/font-awesome/css/fontawesome.min.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/select2/css/select2.min.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/css/libraries/select2.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/toastr/toastr.min.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/mcustom-scrollbar/jquery.mCustomScrollbar.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/flatpickr/flatpickr.min.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
        href="https://cms.botble.com/vendor/core/core/base/libraries/spectrum/spectrum.css?v=7.4.7">
    <link media="all" type="text/css" rel="stylesheet"
    ...
    <script>
        window.siteUrl = "https://cms.botble.com";

        window.siteEditorLocale = "en";
        window.siteAuthorizedUrl = "https://cms.botble.com/admin/settings/license/verify";
...
<body class="page-sidebar-closed-hide-logo page-content-white page-container-bg-solid " style="">
        ...
        <header class="navbar navbar-expand-md d-none d-lg-flex d-print-none" data-bs-theme="dark">
            <div class="container-fluid">
                <button class="navbar-toggler d-none d-lg-block me-2 ms-n1" type="button"
                    ...
                    data-url="https://cms.botble.com/admin/system/users/profile/1/preferences" data-method="PATCH">
                ...
                <h1 class="navbar-brand navbar-brand-autodark me-4">
                    <a href="https://cms.botble.com/admin">
                        <img src="https://cms.botble.com/vendor/core/core/base/images/logo.png"
                            style="max-height: 32px; height: auto;" alt="Botble Technologies"
                ...
                <div class="flex-row navbar-nav order-md-last">
                    ...
                    <div class="d-none d-md-flex me-2">
                        <a href="https://cms.botble.com/admin/toggle-theme-mode?theme=dark"
                            class="px-0 nav-link hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip"
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                <div class="card">
                                    ...
                                    <div class="list-group list-group-flush list-group-hoverable overflow-auto"
                                        ...
                                        <a href="https://cms.botble.com/admin/contacts/edit/8"
                                            class="text-decoration-none">
                                            <div class="list-group-item">
                                                <div class="row">
                                                    <div class="col-auto">
                ...
                <div class="container-xl">
                    ...
                    <div class="collapse navbar-collapse" id="sidebar-menu">
                        <ul class="navbar-nav ">
                            <li class="nav-item ">
                                <a class="nav-link nav-priority--9999" href="https://cms.botble.com/admin"
                                    ...
                                    <span class="nav-link-icon d-md-none d-lg-inline-block" title="Dashboard">
                                        <svg class="icon  svg-icon-ti-ti-home" xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <li class="nav-item ">
                                <a class="nav-link nav-priority-2" href="https://cms.botble.com/admin/pages"
                                    id="cms-core-page" title="Pages">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block" title="Pages">
                                        <svg class="icon  svg-icon-ti-ti-notebook" xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <li class="nav-item dropdown ">
                                <a class="nav-link dropdown-toggle nav-priority-120" href="#cms-plugins-contact"
                                    ...
                                    <span class="nav-link-title text-truncate">
                                        ...
                                        <span
                                            ...
                                            data-url="https://cms.botble.com/admin/menu-items-count"
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start">
                                    ...
                                    <a class="dropdown-item nav-priority-120"
                                        href="https://cms.botble.com/admin/contacts" id="cms-plugins-contact-list"
                                        title="Contacts">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link nav-priority-400" href="https://cms.botble.com/admin/custom-fields"
                            ...
                            <li class="nav-item ">
                                <a class="nav-link nav-priority-410" href="https://cms.botble.com/admin/blocks"
                                    ...
                                    <span class="nav-link-icon d-md-none d-lg-inline-block" title="Static Blocks">
                                        <svg class="icon  svg-icon-ti-ti-code" xmlns="http://www.w3.org/2000/svg"
                                            width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <li class="nav-item dropdown ">
                                ...
                                <div class="dropdown-menu animate slideIn dropdown-menu-start">
                                    ...
                                    <a class="dropdown-item nav-priority-2" href="https://cms.botble.com/admin/menus"
                                        id="cms-core-menu" title="Menus">
                                    ...
                                    <a class="dropdown-item nav-priority-4"
                                        href="https://cms.botble.com/admin/theme/options" id="cms-core-theme-option"
                                        title="Theme Options">
    ...
    <script src="https://cms.botble.com/vendor/core/core/base/js/core-ui.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/excanvas.min.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/ie8.fix.min.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/modernizr/modernizr.min.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/select2/js/select2.min.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/flatpickr/flatpickr.min.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/jquery-cookie/jquery.cookie.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/js/core.js?v=7.4.7"></script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/toastr/toastr.min.js?v=7.4.7"></script>
    <script
        src="https://cms.botble.com/vendor/core/core/base/libraries/mcustom-scrollbar/jquery.mCustomScrollbar.js?v=7.4.7">
    </script>
    <script
        src="https://cms.botble.com/vendor/core/core/base/libraries/stickytableheaders/jquery.stickytableheaders.js?v=7.4.7">
    </script>
    <script src="https://cms.botble.com/vendor/core/core/base/libraries/jquery-waypoints/jquery.waypoints.min.js?v=7.4.7">
    </script>
    ...
    <div class="text-center text-muted">
        ...
        <script src="https://cms.botble.com/vendor/core/core/base/js/global-search.js"></script>
                    ...
                    <form action="https://cms.botble.com/admin/media/files/download-url" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <label class="form-check">
                                ...
                                <span class="form-check-description">If it is unchecked, the image will be displayed
        ...
        <script type="text/javascript">
            const Ziggy = {
                ...
                "routes": {
                    ...
                    "api.sanctum-token.create.store": {
                        "uri": "admin\/settings\/api\/sanctum-token\/create",
                        "methods": ["POST"]
                    },
                    ...
                    "installers.environments.createenvironments.store": {
                    ...
                    "installers.accounts.createaccounts.store": {
                    ...
                    "installers.licenses.createlicenses.store": {
                    ...
                    "contacts.custom-fields.create.store": {
                        "uri": "admin\/contacts\/custom-fields\/create",
                        "methods": ["POST"]
                    },
                    ...
                    "contacts.custom-fields.edit.update": {
                        "uri": "admin\/contacts\/custom-fields\/edit\/{custom_field}",
                        "methods": ["POST"],
                        "wheres": {
                            "custom_field": "[0-9]+"
                    ...
                    "custom-fields.create.store": {
                        "uri": "admin\/custom-fields\/create",
                        "methods": ["POST"]
                    },
                    "custom-fields.edit": {
                        "uri": "admin\/custom-fields\/edit\/{custom_field}",
                        "methods": ["GET", "HEAD"],
                        "wheres": {
                            "custom_field": "[0-9]+"
                        },
                    ...
                    "custom-fields.export": {
                        "uri": "admin\/custom-fields\/export\/{id?}",
                        "methods": ["GET", "HEAD"],
                        "parameters": ["id"]
                    },
                    "custom-fields.import": {
                        "uri": "admin\/custom-fields\/import",
                        "methods": ["POST"]
                    },
                    "galleries.index": {
                        "uri": "admin\/galleries",
                    ...
                    "public.member.posts.create.store": {
                        "uri": "account\/posts\/create",
                        "methods": ["POST"]
                    },
                    ...
                    "public.member.posts.edit.update": {
                        "uri": "account\/posts\/edit\/{post}",
                        "methods": ["POST"],
                        "wheres": {
                            "post": "[0-9]+"
                    ...
                    "public.sitemap.index": {
                        ...
                        "methods": ["GET", "HEAD"],
                        "wheres": {
                            "key": "^(?:sitemap)|(?:pages)|(?:blog-categories)|(?:blog-tags)|(?:blog-posts-((?:19|20|21|22)\\d{2})-(0?[1-9]|1[012]))|(?:galleries)$",
                            "extension": "xml|html|txt|ror-rss|ror-rdf"
                        },
                                ...
                                for (n = 0; n < o.length; ++n)
                                    if (n !== i) {
                                        var f, a, c = o[n],
                                            ...
                                            a)), c.indexOf("[]=") > -1 && (a = $(a) ? [a] : a), e[f] = T.call(e, f) ? b
                                            .combine(e[f], a) : a
                                    } return e
    ...
    <script src="https://cms.botble.com/vendor/core/core/base/js/notification.js"></script>
