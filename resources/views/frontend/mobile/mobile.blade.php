        ...
        <div>
            <article class="card-headline">
                ...
                <div class="card-headline-info">
                    <h4 class="card-headline-title">
                        <a href="?page=detail">Olla Ramlan Pamer Foto Pacar Sean Eh Dibandingin Sama Lolly</a>
                    </h4>
                    <p class="card-headline-desc">Seseorang menspill cara terkenal seseorang diduga Bella Shofie di
                        media sosial Threads.</p>
            ...
            <div class="card-headline-small-wrap">
                <article class="card-headline-small">
                    ...
                    <div class="card-headline-small-info">
                        <h4 class="card-headline-small-title">
                            <a href="?page=detail">Dinda Hauw dan Rey Mbayang Dapat Kado Spesial di Hari...</a>
                        </h4>
                ...
                <article class="card-headline-small">
                    ...
                    <div class="card-headline-small-info">
                        <h4 class="card-headline-small-title">
                            <a href="?page=detail">Pevita Pearce Nikmati Sunset di Pantai: Senyumnya...</a>
                        </h4>
                        <!-- <span class="card-headline-small-category">Seleb</span> -->
                        <div class="category-and-time-head">
                            <span>11:15 WIB</span>
        ...
        <div class="mt-20">
            ...
            <div>
                <article class="main-card">
                    ...
                    <div class="main-card--info">
                        <h4 class="main-card--title">
                            <a href="?page=detail">Happy Asmara Foto Dari Samping, Bentuk Perut Kena Sorot Diduga
                            </a>
                        </h4>
                        <div class="category-and-time">
                            <span>11:15 WIB</span>
                ...
                <div class="list">
                    ...
                    <div class="list-element">
                        <article class="main-card">
                            ...
                            <div class="main-card--info">
                                <h4 class="main-card--title">
                                    <a href="?page=detail">8 Fakta Megan Fox, Aktris yang Tampil Sangat Seksi di
                                        MTV VMA 2021</a>
                                </h4>
                                <div class="category-and-time">
                    ...
                    <div class="list-element">
                        <article class="main-card">
                            <div class="main-card-img-wrap">
                                <img alt="image" class="main-card-img" width="350" height="230"
                                    src="https://images.unsplash.com/photo-1568715684971-9ac138754ab9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&h=400&q=80" />
                            </div>
                            <div class="main-card--info">
                                <h4 class="main-card--title">
                                    <a href="?page=detail">8 Fakta Megan Fox, Aktris yang Tampil Sangat Seksi di
