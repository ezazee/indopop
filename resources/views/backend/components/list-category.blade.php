                        ...
                        <li class="dd-item" data-id="1" data-name="Artificial Intelligence">
                            ...
                            <div class="dd3-content d-flex align-items-center gap-2">
                                <div class="d-flex align-items-center gap-1" style="width: 90%;">
                                    ...
                                    <a href="{{ route('category.edit', ['id' => 1]) }}" class="fetch-data text-truncate" title="ID: 1"
                        ...
                        <li class="dd-item" data-id="2" data-name="Cybersecurity">
                            ...
                            <div class="dd3-content d-flex align-items-center gap-2">
                                <div class="d-flex align-items-center gap-1" style="width: 90%;">
                                    ...
                                    <a href="{{ route('category.edit', ['id' => 2]) }}" class="fetch-data text-truncate" title="ID: 2"
                                        data-bs-toggle="tooltip">
                                        Cybersecurity
                                    </a>

                                    <a href="https://cms.botble.com/cybersecurity" data-bs-toggle="tooltip"
                                        data-bs-original-title="Total posts: 3" target="_blank">(3)</a>

                                    <span data-bs-toggle="modal" data-bs-target=".modal-confirm-delete"
                                        data-url="https://cms.botble.com/admin/blog/categories/2" class="ms-2">
                                        <button class="btn btn-icon btn-danger btn-sm delete-button" type="button"
