    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row d-lg-none">
            <div class="dropdown nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end">
                    <a class="dropdown-item" href="https://cms.botble.com/dashboard/system/users/profile/1">
                    ...
                    <a class="dropdown-item" href="https://cms.botble.com/dashboard/logout">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item {{ Request::is('dashboard/member') || Request::is('dashboard/member/create') || Request::is('dashboard/member/edit/*') ? 'active' : '' }}">
