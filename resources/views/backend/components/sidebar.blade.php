        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav ">
                <li class="nav-item active ">
                    <a class="nav-link nav-priority--9999 active show" href="https://cms.botble.com/admin"
                ...
                <li class="nav-item ">
                    <a class="nav-link nav-priority-2" href="https://cms.botble.com/admin/pages" id="cms-core-page"
                        title="Pages">
                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu animate slideIn dropdown-menu-start">
                        ...
                        <a class="dropdown-item nav-priority-120" href="https://cms.botble.com/admin/contacts"
                        ...
                        <a class="dropdown-item nav-priority-130"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Custom Fields">
                                <svg class="icon  svg-icon-ti-ti-cube-plus" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item ">
                    <a class="nav-link nav-priority-400" href="https://cms.botble.com/admin/custom-fields"
                        ...
                        <span class="nav-link-icon d-md-none d-lg-inline-block" title="Custom Fields">
                            <svg class="icon  svg-icon-ti-ti-table-options" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item ">
                    <a class="nav-link nav-priority-410" href="https://cms.botble.com/admin/blocks"
                        ...
                        <span class="nav-link-icon d-md-none d-lg-inline-block" title="Static Blocks">
                            <svg class="icon  svg-icon-ti-ti-code" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle nav-priority-2000" href="#cms-core-appearance"
                        id="cms-core-appearance" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false" title="Appearance">
                        <span class="nav-link-icon d-md-none d-lg-inline-block" title="Appearance">
                            <svg class="icon  svg-icon-ti-ti-brush" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    <div class="dropdown-menu animate slideIn dropdown-menu-start">
                        ...
                        <a class="dropdown-item nav-priority-1" href="https://cms.botble.com/admin/theme/all"
                            id="cms-core-theme" title="Themes">
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Themes">
                                <svg class="icon  svg-icon-ti-ti-palette" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-2" href="https://cms.botble.com/admin/menus"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Menus">
                                <svg class="icon  svg-icon-ti-ti-tournament" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-3" href="https://cms.botble.com/admin/widgets"
                            id="cms-core-widget" title="Widgets">
                        ...
                        <a class="dropdown-item nav-priority-4" href="https://cms.botble.com/admin/theme/options"
                        ...
                        <a class="dropdown-item nav-priority-5" href="https://cms.botble.com/admin/theme/custom-css"
                            id="cms-core-appearance-custom-css" title="Custom CSS">
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Custom CSS">
                                <svg class="icon  svg-icon-ti-ti-file-type-css" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-6" href="https://cms.botble.com/admin/theme/custom-js"
                            id="cms-core-appearance-custom-js" title="Custom JS">
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Custom JS">
                                <svg class="icon  svg-icon-ti-ti-file-type-js" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-6" href="https://cms.botble.com/admin/theme/custom-html"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Custom HTML">
                                <svg class="icon  svg-icon-ti-ti-file-type-html" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-6" href="https://cms.botble.com/admin/theme/robots-txt"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Robots.txt Editor">
                                <svg class="icon  svg-icon-ti-ti-file-type-txt" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle nav-priority-3000" href="#cms-core-plugins"
                        id="cms-core-plugins" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="false" title="Plugins">
                        <span class="nav-link-icon d-md-none d-lg-inline-block" title="Plugins">
                            <svg class="icon  svg-icon-ti-ti-plug" xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                <path
                    ...
                    <div class="dropdown-menu animate slideIn dropdown-menu-start">
                        ...
                        <a class="dropdown-item nav-priority-1" href="https://cms.botble.com/admin/plugins/installed"
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block" title="Installed Plugins">
                                <svg class="icon  svg-icon-ti-ti-square-check" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <a class="dropdown-item nav-priority-2" href="https://cms.botble.com/admin/plugins/new"
