                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="https://cms.botble.com/admin/system/roles" accept-charset="UTF-8"
                                class="filter-form">
                                <input type="hidden" name="filter_table_id" class="filter-data-table-id"
                                    value="botble-a-c-l-tables-role-table">
                                <input type="hidden" name="class" class="filter-data-class"
                                    value="Botble\ACL\Tables\RoleTable">
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="https://cms.botble.com/admin/system/roles"
                        ...
                        <div class="w-100 justify-content-between d-flex flex-wrap align-items-center gap-1">
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\ACL\Tables\RoleTable"
                                        ...
                                        <a class="dropdown-item" href="https://cms.botble.com/admin/tables/bulk-actions"
                                            ...
                                            data-table-target="Botble\ACL\Tables\RoleTable"
                            ...
                            <div class="d-flex align-items-center gap-1">
                                <button class="btn action-item btn-primary " tabindex="0"
                                    aria-controls="botble-a-c-l-tables-role-table" type="button" aria-haspopup="dialog"
                                    aria-expanded="false">
                                    <span data-action="create"
                                        data-href="{{ route('settings.createRolesPermission') }}">
                                ...
                                <button class="btn" type="button" data-bb-toggle="dt-buttons"
                                    ...
                                    aria-controls="botble-a-c-l-tables-role-table">
                    ...
                    <div class="card-table">
                        <div class="table-responsive table-has-actions table-has-filter">
                            <table class="table card-table table-vcenter table-striped table-hover"
                                id="botble-a-c-l-tables-role-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th title="Description" class="text-start  column-key-2">
                                            Description
                                        </th>
                                        <th title="Created At" width="100" class=" column-key-3">
                                            Created At
                                        </th>
                                        <th title="Created By" width="100" class=" column-key-4">
                                            Created By
                                        </th>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        <td class="w-1 text-start no-column-visibility dtr-control"><input
                                                ...
                                                name="id[]" value="2"></td>
                                        <td class="text-center no-column-visibility column-key-0 sorting_1">2</td>
                                        <td class="  text-start  column-key-1"><a
                                                href="{{ route('settings.editRolesPermission') }}"
                                                title="Nguyenvana">Nguyenvana</a></td>
                                        <td class="  text-start  column-key-2">bhjjh</td>
                                        <td class="   column-key-3">2024-12-16</td>
                                        <td class="   column-key-4"><a
                                                href="https://cms.botble.com/admin/system/users/profile/1" title="1"
                                                target="_blank">Conor Smith<svg
                                                    class="icon ms-1 svg-icon-ti-ti-external-link"
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <td class="  text-center no-column-visibility text-nowrap">
                                            <div class="table-actions">
                                                <a href="{{ route('settings.editRolesPermission') }}"
                                                ...
                                                <a href="https://cms.botble.com/admin/system/roles/2"
                                    ...
                                    <tr class="even">
                                        <td class="w-1 text-start no-column-visibility dtr-control"><input
                                                class="form-check-input m-0 align-middle checkboxes" type="checkbox"
                                                name="id[]" value="1"></td>
                                        <td class="text-center no-column-visibility column-key-0 sorting_1">1</td>
                                        <td class="  text-start  column-key-1"><a
                                                href="https://cms.botble.com/admin/system/roles/edit/1"
                                                title="Admin">Admin</a></td>
                                        <td class="  text-start  column-key-2">Admin users role</td>
                                        ...
                                        <td class="  text-center no-column-visibility text-nowrap">
                                            <div class="table-actions">
                                                <a href="https://cms.botble.com/admin/system/roles/edit/1"
                                                    class="btn btn-sm btn-icon btn-primary">
                                                    <svg class="icon  svg-icon-ti-ti-edit" data-bs-toggle="tooltip"
                                                        data-bs-title="Edit" xmlns="http://www.w3.org/2000/svg"
                                                        width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <a href="https://cms.botble.com/admin/system/roles/1"
                                                    data-dt-single-action="" data-method="DELETE"
                                                    data-confirmation-modal="true"
                                                    data-confirmation-modal-title="Confirm delete"
                                                    data-confirmation-modal-message="Do you really want to delete this record?"
