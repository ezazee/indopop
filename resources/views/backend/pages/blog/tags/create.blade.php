...
@section('content')
    ...
    <div class="page-body page-content">
        <div class="container-xl">
            ...
            <form method="POST" action="https://cms.botble.com/admin/blog/tags/create" accept-charset="UTF-8"
                                    ...
                                    <div class="mb-3 ">
                                        <div class="slug-field-wrapper" data-field-name="name">
                                            ...
                                            <small class="form-hint mt-n2 text-truncate">Preview: <a
                                                    href="https://cms.botble.com/tag/"
                                                    target="_blank">https://cms.botble.com/tag/</a></small>
                                            <input class="slug-current" name="slug" type="hidden" value="">
                                            <div class="slug-data" data-url="https://cms.botble.com/ajax/slug/create"
                                                data-view="https://cms.botble.com/tag/" data-id="0">
                                            </div>
