                ...
                <div class="card mb-3 table-configuration-wrap" style="display: none;">
                    <div class="card-body">
                        ...
                        <div class="wrapper-filter">
                            ...
                            <form method="GET" action="https://cms.botble.com/admin/blog/tags" accept-charset="UTF-8"
                                class="filter-form">
                                <input type="hidden" name="filter_table_id" class="filter-data-table-id"
                                    value="botble-blog-tables-tag-table">
                                <input type="hidden" name="class" class="filter-data-class"
                                    value="Botble\Blog\Tables\TagTable">
                                ...
                                <div class="btn-list">
                                    ...
                                    <a class="btn btn-icon" style="display: none;" type="button"
                                        href="https://cms.botble.com/admin/blog/tags"
                                ...
                                <div class="dropdown d-inline-block">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-submenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <button class="dropdown-item bulk-change-item" data-key="name"
                                                    data-class-item="Botble\Blog\Tables\TagTable"
                                        ...
                                        <a class="dropdown-item" href="https://cms.botble.com/admin/tables/bulk-actions"
                                            ...
                                            data-table-target="Botble\Blog\Tables\TagTable"
                            ...
                            <table class="table card-table table-vcenter table-striped table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th title="Created At" width="100" class=" column-key-2">
                                            Created At</th>
                                        <th title="Status" width="100" class="text-center column-key-3">Status</th>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        <td class="w-1 text-start no-column-visibility dtr-control"><input
                                                ...
                                                name="id[]" value="8"></td>
                                        <td class="text-center no-column-visibility column-key-0 sorting_1">8</td>
                                        <td class="text-start  column-key-1"><a href="{{ route('tags.edit') }}"
                                                title="AR Gaming">AR
                                                Gaming</a></td>
                                        <td class="column-key-2">2024-09-01</td>
                                        ...
                                        <td class="  text-center no-column-visibility text-nowrap">
                                            <div class="table-actions">
                                                ...
                                                <a href="https://cms.botble.com/admin/blog/tags/8"
