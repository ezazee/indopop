                     ...
                     <div class="tab-content">
                        <div class="tab-pane active show" id="tabs-detail">
                           ...
                           <div class="mb-3 ">
                              <div class="slug-field-wrapper" data-field-name="name">
                                 ...
                                 <small class="form-hint mt-n2 text-truncate">Preview: <a
                                    href="{{ config('app.url') }}/detail/{{ $post->slug }}"
                                    target="_blank">{{ config('app.url') }}/detail/{{ $post->slug }}</a></small>
                           ...
                           <div class="mb-3 position-relative">
                              ...
                              placeholder="Write your content" with-short-code id="content" name="content" cols="50">{!! $post->content !!}</textarea>
                           </div>
                        </div>
                     </div>
                  </div>
                       ...
                       @foreach ($category as $item)
                          <li>
                             <label class="form-check">
                                <input type="checkbox" name="categories" class="form-check-input category-checkbox" data-category-id="{{ $item->id }}">
