                        ...
                        <div class="file-tree-wrapper" data-url=""
                            ...
                            <div class="dd" data-depth="0" data-empty-text="No categories found.">
                                <ol class="list-group dd-list ">
                                    ...
                                    <li class="dd-item" data-id="{{ $category->nama_kategori }}" data-name="Artificial Intelligence">
                                        ...
                                        <div class="dd3-content d-flex align-items-center gap-2">
                                            <div class="d-flex align-items-center gap-1" style="width: 90%;">
                                                ...
                                                <a href="{{ route('category.edit', ['id' => $item->id ]) }}" class="fetch-data text-truncate"
                                                ...
                                                <span class="ms-2">
                                                    ...
                                                    <form action="{{ route('category.destroy', ['id' => $item->id]) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                                                        
                                                        <button class="btn btn-icon btn-danger btn-sm" type="submit" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
