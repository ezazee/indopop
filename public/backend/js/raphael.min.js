...
(function (a) {
    ...
    (function () {
        ...
        function a(c) {
            ...
            if (a.is(c, E))
                return a._engine.create[m](
                    a,
                    c.splice(0, 3 + a.is(c[0], C))
                ).add(c);
        ...
        var bI = (a.pathBBox = function (a) {
            ...
            bO = function (a, b, c, d, e, f, g, h, i, j) {
                ...
                for (var W = 0, X = m.length; W < X; W++)
                    V[W] =
                        W % 2 ? p(m[W - 1], m[W], l).y : p(m[W], m[W + 1], l).x;
                return V;
            },
            ...
            bQ = bv(function (a, b, c, d, e, f, g, h) {
                ...
                z(l) > "1e12" && (l = 0.5),
                    ...
                    l > 0 &&
                        l < 1 &&
                        ((q = bP(a, b, c, d, e, f, g, h, l)),
                        p.push(q.x),
                        o.push(q.y)),
                    n > 0 &&
                        n < 1 &&
                        ((q = bP(a, b, c, d, e, f, g, h, n)),
                        p.push(q.x),
                        o.push(q.y)),
                    (i = f - 2 * d + b - (h - 2 * f + d)),
                    (j = 2 * (d - b) - 2 * (f - d)),
            ...
            bR = (a._path2curve = bv(
                function (a, b) {
                    ...
                    for (
                        var k = 0, l = x(d.length, (e && e.length) || 0);
                        k < l;
                        k++
                    ) {
                        (d[k] = h(d[k], f)),
                ...
                if (h.doc.addEventListener)
                    return function (a, b, c, d) {
                        var e = o && u[b] ? u[b] : b,
                            f = function (e) {
                                var f =
                                        h.doc.documentElement.scrollTop ||
                                        h.doc.body.scrollTop,
                                    i =
                                        h.doc.documentElement.scrollLeft ||
            ...
            cj = function (a) {
                ...
                while (g--) {
                    ...
                    h.win.opera && n.removeChild(k),
                        ...
                        (k.style.display = p),
                        h.win.opera &&
                            (m ? n.insertBefore(k, m) : n.appendChild(k)),
        ...
        (cl.data = function (b, c) {
            ...
            (cl.removeData = function (a) {
                a == null
                    ? (bb[this.id] = {})
                    : bb[this.id] && delete bb[this.id][a];
                return this;
            }),
        ...
        var co = function (a) {
            var b = a.getBoundingClientRect(),
                ...
                i =
                    b.top +
                    (h.win.pageYOffset || e.scrollTop || d.scrollTop) -
                    f,
                j =
                    b.left +
                    (h.win.pageXOffset || e.scrollLeft || d.scrollLeft) -
                    g;
            return { y: i, x: j };
        };
                            ...
                            if (i[g](u)) {
                                switch (U[u]) {
                                    ...
                                    case "path":
                                        p = [];
                                        for (
                                            var v = 0, w = i[u].length;
                                            v < w;
                                            v++
                                        ) {
                                            p[v] = [i[u][v][0]];
                                            for (
                                                var x = 1, y = i[u][v].length;
                                                x < y;
                                                x++
                                            )
                                                p[v][x] =
            ...
            (cl.resume = function (a) {
                for (var b = 0; b < cy.length; b++)
                    if (cy[b].el.id == this.id && (!a || cy[b].anim == a)) {
                        var c = cy[b];
                        eve("raphael.anim.resume." + this.id, this, c.anim) !==
                            !1 &&
        ...
        var cG = function (a) {
                ...
                if (a)
                    for (var b = 0, c = a.length; b < c; b++)
                        a[b] &&
                            (a[b].constructor == cl.constructor ||
                                a[b].constructor == cG) &&
                ...
                t = function (d, e, f) {
                    if (d.type == "path") {
                        ...
                        if (r != "none") {
                            ...
                            C
                                ? (p[B]++,
                                  (D = C.getElementsByTagName("use")[0]))
                                : ((C = q(q("marker"), {
                                      id: B,
                                      markerHeight: y,
                                      markerWidth: x,
                            ...
                            f
                                ...
                                : ((s = F * m),
                                  (t =
                                      a.getTotalLength(k.path) -
                                      (d._.arrows.enddx * m || 0))),
                                (w = {}),
                                (w["marker-" + i] = "url(#" + B + ")");
            ...
            (z.prototype = A),
                ...
                (A.scale = function (a, b, e, f) {
                    ...
                    (e = e == null ? g.x + g.width / 2 : e),
                        ...
                        this.transform(
                            this._.transform.concat([["s", a, b, e, f]])
                        );
                    return this;
                }),
            ...
            (D.prototype = E),
                ...
                (E.transform = function (b) {
                    ...
                    var d = this.paper._viewBoxShift,
                        e = d
                            ? "s" + [d.scale, d.scale] + "-1-1t" + [d.dx, d.dy]
                            : o,
                        f;
                    d &&
                        (f = b =
                ...
                (E.rotate = function (a, b, e) {
                    ...
                    if (a != null) {
                        ...
                        (this._.dirtyT = 1),
                            this.transform(
                                this._.transform.concat([["r", a, b, e]])
                            );
                        return this;
                    }
                }),
                (E.translate = function (a, b) {
                    ...
                    (a = c(a).split(k)),
                        ...
                        (b = +b || 0),
                        this._.bbox &&
                            ((this._.bbox.x += a), (this._.bbox.y += b)),
                        this.transform(this._.transform.concat([["t", a, b]]));
                    return this;
                }),
                ...
                (a._engine.setViewBox = function (b, c, d, e, f) {
                    a.eve("raphael.setViewBox", this, this._viewBox, [
                        b,
                        c,
                        d,
                        e,
